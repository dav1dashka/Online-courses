(() => {
            ...
            function setSpollerAction(e) {
                ...
                if (el.closest("[data-spoller]")) {
                    ...
                    if (!spollersBlock.querySelectorAll("._slide").length) {
                        ...
                        spollerTitle.firstElementChild.classList.toggle("active");
                    }
                    e.preventDefault();
                }
            }
    ...
    function initSliders() {
        ...
        if (document.querySelector(".students-page__slider")) new core(".students-page__slider", {
            ...
            loop: true,
            pagination: {
                el: ".students-page__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".students-page-button-prev",
                nextEl: ".students-page-button-next"
            },
            on: {}
        });
        if (document.querySelector(".other-course__slider")) new core(".other-course__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".other-course__button-prev",
                nextEl: ".other-course__button-next "
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        function pageNavigationAction(e) {
            if (e.type === "click") {
                ...
                if (targetElement.closest("[data-goto]")) {
                    ...
                    const offsetTop = gotoLink.dataset.gotoTop ? parseInt(gotoLink.dataset.gotoTop) : 110;
    ...
    class ItcTabs {
        constructor(target, config) {
            ...
            this._elButtons = this._elTabs.querySelectorAll(".tabs-benefits__btn");
            this._elPanes = this._elTabs.querySelectorAll(".tabs-benefits__pane");
        ...
        show(elLinkTarget) {
            ...
            const elLinkActive = this._elTabs.querySelector(".tabs-benefits__btn_active");
            const elPaneShow = this._elTabs.querySelector(".tabs-benefits__pane_show");
            if (elLinkTarget === elLinkActive) return;
            elLinkActive ? elLinkActive.classList.remove("tabs-benefits__btn_active") : null;
            elPaneShow ? elPaneShow.classList.remove("tabs-benefits__pane_show") : null;
            elLinkTarget.classList.add("tabs-benefits__btn_active");
            elPaneTarget.classList.add("tabs-benefits__pane_show");
        ...
        _events() {
            this._elTabs.addEventListener("click", (e => {
                const target = e.target.closest(".tabs-benefits__btn");
                if (target) {
                    e.preventDefault();
                    this.show(target);
                }
    ...
    if (document.querySelector(".benefits-page__container")) new ItcTabs(".tabs-benefits");
    const mainHeader = document.querySelector("header");
    window.location.href.includes("courses.html") ? mainHeader.style.backgroundColor = "#fff" : mainHeader.style.backgroundColor = "#feddcf";
    let menuLinks = document.querySelectorAll(".menu__link");
    window.addEventListener("DOMContentLoaded", (() => {
        menuLinks.forEach((item => {
            let match = /\/([^/]+)\.html/.exec(window.location.href);
            let matchTwo = /(?<=html\/)(\w+)(?=\/)/.exec(window.location.href);
            if (match != null) if (match[1] !== null && match[1].toUpperCase() == item.getAttribute("data-menu-link").toUpperCase()) item.classList.add("active");
            if (matchTwo != null) if (matchTwo[1].toUpperCase() == item.getAttribute("data-menu-link").toUpperCase()) item.classList.add("active");
        }));
    }));
    if (window.location.href.includes("courses.html")) {
        let courses = {
            course: [{
                ...
                category: "Marketing",
                categoryBackground: "03CEA4",
                price: "100",
                image: "img/courses/filter/01.jpg",
                creator: "by Jerome Bell"
            }, {
                id: 2,
                courseName: "Prduct Management Fundamentals",
                category: "Management",
                categoryBackground: "5A87FC",
                price: "480",
                image: "img/courses/filter/02.jpg",
                creator: "by Marvin McKinney"
            }, {
                id: 3,
                courseName: "HR  Management and Analytics",
                category: "HR & Recruting",
                categoryBackground: "F89828",
                price: "200",
                image: "img/courses/filter/03.jpg",
                creator: "by Leslie Alexander Li"
            }, {
                id: 4,
                ...
                categoryBackground: "03CEA4",
                price: "530",
                image: "img/courses/filter/04.jpg",
                creator: "by Kristin Watson"
            }, {
                id: 5,
                courseName: "Graphic Design Basic",
                category: "Design",
                categoryBackground: "F52F6E",
                price: "500",
                image: "img/courses/filter/06.jpg",
                creator: "by Guy Hawkins"
            }, {
                id: 6,
                ...
                categoryBackground: "5A87FC",
                price: "400",
                image: "img/courses/filter/05.jpg",
                creator: "by Dianne Russell"
            }, {
                id: 7,
                courseName: "Highload Software Architecture",
                category: "Development",
                categoryBackground: "7772F1",
                price: "600",
                image: "img/courses/filter/07.jpg",
                creator: "by Brooklyn Simmons"
            }, {
                id: 8,
                ...
                categoryBackground: "F89828",
                price: "150",
                image: "img/courses/filter/08.jpg",
                creator: "by Kathryn Murphy"
            }, {
                id: 9,
        ...
        let btnLoadMore = document.querySelector(".courses__load-more");
        let loadMoreCover = document.querySelector(".courses__load-more-cover");
        ...
        btnLoadMore.addEventListener("click", (e => {
            ...
            e.preventDefault();
            let num = cards.length + 3;
            let activeTab = document.querySelector(".tabs-courses__cover.active button");
            createCard(num);
            filterAddNum();
            filterCourse(activeTab.getAttribute("data-card"));
            goToCardPage();
        }));
        const mainTabs = document.querySelector(".tabs-courses");
        let buttons = document.querySelectorAll(".tabs-courses__tab");
        let buttonsCover = document.querySelectorAll(".tabs-courses__cover");
        mainTabs.addEventListener("click", (e => {
            buttons.forEach(((button, index) => {
                if (e.target === buttonsCover[index] || e.target === button) filterCourse(button.getAttribute("data-card"));
            }));
        }));
        function filterCourse(value) {
            cards = document.querySelectorAll(".courses__card");
            buttons.forEach((button => {
                if (value.replace(/\s+/g, "").toUpperCase() == button.innerText.replace(/\s+/g, "").toUpperCase()) button.parentElement.classList.add("active"); else button.parentElement.classList.remove("active");
            }));
            cards.forEach((card => {
                if (value.toLowerCase() == "all") card.classList.remove("hide"); else if (card.classList.contains(value)) card.classList.remove("hide"); else card.classList.add("hide");
            }));
            removeCoursesWarning();
        }
        window.onload = () => {
            filterCourse("all");
        };
        function filterAddNum() {
            const numBlocks = document.querySelectorAll(".tabs-courses__num");
            const wordCounts = {};
            cards = document.querySelectorAll(".courses__card");
            cards.forEach((card => {
                if (wordCounts[card.classList[1]]) wordCounts[card.classList[1]]++; else wordCounts[card.classList[1]] = 1;
            }));
            numBlocks.forEach(((numBlock, index) => {
                const buttonCategory = buttons[index].innerText.replace(/\s+/g, "");
                const categoryCount = wordCounts[buttonCategory] || 0;
                if (buttonCategory == "All") numBlocks[0].innerText = cards.length; else numBlock.innerText = categoryCount;
            }));
        }
        filterAddNum();
        let searchInput = document.getElementById("search-input");
        let searchIcon = document.querySelector("#search");
        function searchInputCourses() {
            let elements = document.querySelectorAll(".product-name");
            let counter = 0;
            elements.forEach(((element, index) => {
                if (element.innerText.toUpperCase().includes(searchInput.value.toUpperCase())) {
                    cards[index].classList.remove("hide");
                    removeCoursesWarning();
                } else {
                    cards[index].classList.add("hide");
                    counter++;
                    if (counter >= cards.length) addCoursesWarning();
                }
            }));
        }
        function addCoursesWarning() {
            document.querySelector(".courses__warning").classList.add("active");
            document.querySelector(".courses__warning").innerText = `Sorry whe could not find any courses with name: "${searchInput.value}"`;
        }
        function removeCoursesWarning() {
            document.querySelector(".courses__warning").classList.remove("active");
        }
        searchInput.addEventListener("keypress", (e => {
            if (e.key === "Enter") searchInputCourses();
        }));
        searchIcon.addEventListener("click", (() => {
            searchInputCourses();
        }));
    }
    function goToCardPage(cards) {
        cards = document.querySelectorAll(".courses__card");
        cards.forEach((card => {
    ...
    if (document.querySelectorAll(".courses__card")) goToCardPage(document.querySelectorAll(".courses__card"));
    if (document.querySelectorAll(".item-featured-courses-page")) goToCardPage(document.querySelectorAll(".item-featured-courses-page"));
    if (window.location.href.includes("course.html")) {
        window.addEventListener("load", (() => {
            let coursesPages = {
                coursePage: [{
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$100 per course",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    ...
                    aboutCourseDurationLabel: "Rhoncusauctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$480 per course",
                    aboutCoursePriceLabel: "Nulla sem adfringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$66 per mounth",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$132 per month",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$500 per course",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$400 per course",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$150 per course",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$120 per month",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$530 per course",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    curatorCourseTitle: "Kristin Watson",
                    curatorCoursePosition: "Senior UX designer in IT Product Company",
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$200 per course",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    curatorCourseTitle: "Dianne Russell",
                    curatorCoursePosition: "Senior UX designer in IT Product Company",
                    ...
                    aboutCourseDurationLabel: "Rhoncus pellentesque auctor auctor orci vulputate faucibus quis ut.",
                    aboutCoursePrice: "$600 per course",
                    aboutCoursePriceLabel: "Nulla sem adipiscing adipiscing felis fringilla. Adipiscing mauris quam ac elit tristique dis.",
                    curatorCourseImage: "img/course/09.png",
                    curatorCourseTitle: "Brooklyn Simmons",
                    curatorCoursePosition: "Senior UX designer in IT Product Company",
            ...
            class coursePage {
                constructor(id, titlesPageTitle, aboutCourseText, aboutCourseItems, aboutCourseDates, aboutCourseDatesLabel, aboutCourseDuration, aboutCourseDurationLabel, aboutCoursePrice, aboutCoursePriceLabel, curatorCourseImage, curatorCourseTitle, curatorCoursePosition, curatorCourseInfoIcon, curatorCourseInfo, curatorCourseText, curatorCourseLinksIcon, curatorCourseLinks, courseWhomItems, courseProgramTitles, courseProgramTextes, ...classes) {
                    this.id = id;
                    this.titlesPageTitle = titlesPageTitle;
                    this.aboutCourseText = aboutCourseText;
                    this.aboutCourseItems = aboutCourseItems;
                    this.aboutCourseDates = aboutCourseDates;
                    this.aboutCourseDatesLabel = aboutCourseDatesLabel;
                    this.aboutCourseDuration = aboutCourseDuration;
                    this.aboutCourseDurationLabel = aboutCourseDurationLabel;
                    this.aboutCoursePrice = aboutCoursePrice;
                    this.aboutCoursePriceLabel = aboutCoursePriceLabel;
                    this.curatorCourseImage = curatorCourseImage;
                    this.curatorCourseTitle = curatorCourseTitle;
                    this.curatorCoursePosition = curatorCoursePosition;
                    this.curatorCourseInfoIcon = curatorCourseInfoIcon;
                    this.curatorCourseInfo = curatorCourseInfo;
                    this.curatorCourseText = curatorCourseText;
                    this.curatorCourseLinksIcon = curatorCourseLinksIcon;
                    this.curatorCourseLinks = curatorCourseLinks;
                    this.courseWhomItems = courseWhomItems;
                    this.courseProgramTitles = courseProgramTitles;
                    this.courseProgramTextes = courseProgramTextes;
                    this.classes = classes;
                }
                render() {
                    const titlesPageTitle = document.querySelector(".container-titles-page h1");
                    titlesPageTitle.innerText = `${this.titlesPageTitle}`;
                    const aboutCourseText = document.querySelector(".about-course__text p");
                    aboutCourseText.innerText = `${this.aboutCourseText}`;
                    const aboutCourseItemsCover = document.querySelector(".about-course__items");
                    this.aboutCourseItems.forEach((element => {
                        let item = document.createElement("li");
                        item.classList.add("whoweare-page__item");
                        item.innerText = `${element}`;
                        aboutCourseItemsCover.append(item);
                    }));
                    const aboutCourseTitles = document.querySelectorAll(".right-about-course__info span");
                    const aboutCourseDatesLabels = document.querySelectorAll(".right-about-course__label span");
                    aboutCourseTitles[0].innerText = `${this.aboutCourseDates}`;
                    aboutCourseDatesLabels[0].innerText = `${this.aboutCourseDatesLabel}`;
                    aboutCourseTitles[1].innerText = `${this.aboutCourseDuration}`;
                    aboutCourseDatesLabels[1].innerText = `${this.aboutCourseDurationLabel}`;
                    aboutCourseTitles[2].innerText = `${this.aboutCoursePrice}`;
                    aboutCourseDatesLabels[2].innerText = `${this.aboutCoursePriceLabel}`;
                    const curatorCourseImage = document.querySelector(".curator-course__image img");
                    curatorCourseImage.setAttribute("src", this.curatorCourseImage);
                    const curatorCourseTitle = document.querySelector(".curator-course__title");
                    curatorCourseTitle.innerText = `${this.curatorCourseTitle}`;
                    const curatorCoursePosition = document.querySelector(".curator-course__position");
                    curatorCoursePosition.innerText = `${this.curatorCoursePosition}`;
                    const curatorCourseInfo = document.querySelectorAll(".curator-course__item");
                    curatorCourseInfo.forEach(((item, index) => {
                        item.innerText = `${this.curatorCourseInfo[index]}`;
                        const itemSpan = document.createElement("span");
                        itemSpan.classList.add(`${this.curatorCourseInfoIcon[index]}`);
                        item.prepend(itemSpan);
                    }));
                    const curatorCourseText = document.querySelector(".curator-course__text p");
                    curatorCourseText.innerText = `${this.curatorCourseText}`;
                    const curatorCourseLinksCover = document.querySelector(".curator-course__links");
                    this.curatorCourseLinks.forEach(((element, index) => {
                        let item = document.createElement("a");
                        item.setAttribute("href", element);
                        item.classList.add(this.curatorCourseLinksIcon[index]);
                        curatorCourseLinksCover.append(item);
                    }));
                    const courseWhomItemsCover = document.querySelector(".whom-course__items");
                    this.courseWhomItems.forEach((element => {
                        let item = document.createElement("li");
                        item.classList.add("whoweare-page__item");
                        item.innerText = `${element}`;
                        courseWhomItemsCover.append(item);
                    }));
                    const courseProgramSpoiller = document.querySelector(".program-course__lessons");
                    this.courseProgramTitles.forEach(((element, index) => {
                        const item = document.createElement("div");
                        item.classList.add("spollers__item");
                        item.classList.add("lesson-program");
                        const titles = document.createElement("div");
                        titles.setAttribute("data-spoller", "");
                        titles.classList.add("spollers__title");
                        titles.classList.add("lesson-program__titles");
                        const icon = document.createElement("div");
                        icon.classList.add("lesson-program__icon");
                        titles.append(icon);
                        const label = document.createElement("div");
                        label.classList.add("lesson-program__label");
                        label.innerText = `Lesson ${index + 1}`;
                        titles.append(label);
                        const title = document.createElement("h3");
                        title.classList.add("lesson-program__title");
                        title.innerText = `${element}`;
                        titles.append(title);
                        const body = document.createElement("div");
                        body.setAttribute("hidden", "");
                        body.classList.add("spollers__body");
                        body.classList.add("lesson-program__body");
                        body.innerText = `${this.courseProgramTextes[index]}`;
                        item.append(titles);
                        item.append(body);
                        courseProgramSpoiller.append(item);
                    }));
                }
            }
        ...
        function setTime(selector, eventtime) {
            const timer = document.querySelector(selector), days = timer.querySelector("#days"), hours = timer.querySelector("#hours"), minutes = timer.querySelector("#minutes"), seconds = timer.querySelector("#seconds"), timeInterval = setInterval(updateTime, 1e3);
            updateTime();
            function updateTime() {
                const items = getRestOftime(eventtime);
                days.innerHTML = addZero(items.days);
                hours.innerHTML = addZero(items.hours);
                minutes.innerHTML = addZero(items.minutes);
                seconds.innerHTML = addZero(items.seconds);
                if (items.total <= 0) {
                    clearTimeout(timeInterval);
                    document.querySelectorAll(".timer-discount__block").forEach((item => {
                        item.style.display = "none";
                    }));
                    const banner = document.createElement("div");
                    banner.style.cssText = `\n                    color: var(--gray-900, #1E212C);\n                    font-size: 24px;\n                    font-weight: 700;\n                    line-height: 130%;\n                `;
                    banner.innerText = "The offer has ended";
                    timer.append(banner);
                    timer.style.alignItems = "center";
                    const button = document.querySelector(".discount-course__button button");
                    button.classList.add("disabled-button");
                    button.style.cursor = "default";
                    button.addEventListener("click", (e => {
                        e.preventDefault();
                    }));
                    document.querySelector(".register-course__label").style.display = "none";
                }
            }
        }
        ...
        setTime(".timer-discount", eventTime);
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
